 ...
 * No JavaScript logic or state management required
 */
export default function HowItWorks() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 text-[#3b3b3b]">
      ...
      <h2 className="text-2xl font-semibold mt-10 mb-4 text-[#3b3b3b]">
        1. Create a campaign
      </h2>
      ...
      <ul className="list-disc list-inside text-lg leading-relaxed space-y-2 mt-4 text-[#6b6b6b]">
        ...
        <li>
          The campaign deadline is reached
        </li>
      </ul>
